...
```
## 4. Data capture tool: Colleting data using interactive Jupyter widgets

*Description of the code: 

  -Language (Python) in Jupyter
  
  -The data is collected using interactive widgets
  
  -The data is stored in the RawData folder
